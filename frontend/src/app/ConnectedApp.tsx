...
export function ConnectedApp() {
  ...
  return (
    <div className={styles.root}>
      ...
      {route.name === 'moderation' ? <ConnectedModerationScreen enabled={isAdmin} onBack={back} onOpenMarket={(marketId) => push({ name: 'detail', marketId })} /> : null}
